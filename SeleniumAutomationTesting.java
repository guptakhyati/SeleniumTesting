...
public class SeleniumAutomationTesting{
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(3000);
        driver.findElement(By.name("Name")).sendKeys("Khyati Gupta");
        Thread.sleep(3000);
        driver.findElement(By.name("Email")).sendKeys("khyati.gupta2000@gmail.com");
        Thread.sleep(3000);
